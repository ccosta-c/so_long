...
#    Updated: 2023/02/24 16:10:33 by ccosta-c         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC				= check_map.c ft_print_array.c get_map.c map_size.c utils.c draw_windows.c free_array.c draw_map.c handle_events.c
OBJS 			:= $(SRC:.c=.o)
OBJS_BONUS		= 
NAME			= so_long
NAME_BONUS		= so_long
